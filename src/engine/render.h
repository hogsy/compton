...
namespace engine::render
{
	...
	void DrawBitmap( const uint8_t *pixels, uint8_t pixelSize, const vc::ImageManager::Palette *palette, int x, int y, int w, int h, bool alphaTest, FlipDirection flipDirection = FlipDirection::FLIP_NONE );
