...
Sprite::Sprite( ALLEGRO_BITMAP *bitmap ) : bitmap_( bitmap ), origin_( 0, 0 ), position_( 0, 0 ), angle( 0 ),
                                           current_frame_( 0 ), frame_count_( 0 ), frame_delay_( 0 ) {
...
Sprite::Sprite( ALLEGRO_BITMAP *bitmap, float x, float y ) : bitmap_( bitmap ), origin_( 0, 0 ), position_( x, y ), angle( 0 ),
                                                             current_frame_( 0 ), frame_count_( 0 ), frame_delay_( 0 ) {
	frame_w_ = _w = al_get_bitmap_width( bitmap );
	frame_h_ = _h = al_get_bitmap_height( bitmap );
	origin_.Set( _w / 2, _h / 2 );
