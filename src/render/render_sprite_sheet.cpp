...
#include "render_sprite_sheet.h"

SpriteSheet::SpriteSheet( const char *path, ALLEGRO_BITMAP *bitmap ) : ScriptParser( path ), bitmap( bitmap )
{
...
bool SpriteSheet::GetSpriteCoordinates( const char *spriteName, int *x, int *y, int *w, int *h ) const
{
...
const SpriteSheet::SpriteRect *SpriteSheet::GetSpriteRect( const char *spriteName ) const
{
